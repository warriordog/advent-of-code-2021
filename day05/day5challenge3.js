...
const aaLines = readLines('5-50000-10000000.in');

// Load axis-aligned lines
aaLines.filter(line => isAxisAligned(line))
    .forEach(line => addLine(line));
console.log(`Day5 Challenge3 Part1: There are ${ overlaps } points of overlap.`);

// Load diagonal lines
aaLines.filter(line => !isAxisAligned(line))
    .forEach(line => addLine(line));
console.log(`Day5 Challenge3 Part2: There are ${ overlaps } points of overlap.`);